...
function initMap() {
  ...
  var map = L.map('map').setView([40.663382442278674, -73.90224307468691], 18);
  L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
  }).addTo(map);
  L.marker([40.663382442278674, -73.90224307468691]).addTo(map).bindPopup('We are here!').openPopup();
}
